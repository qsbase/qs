...
* Starting from version 0.20.1, `qs` efficiently serializes S4 objects, environments, and other complex objects.  
...
[1] 1 2 3
```
The direct C++ functions do not have default parameters; all paramters must be specified.  
