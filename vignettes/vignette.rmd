...
In `qs`, `ALTREP` character vectors are used (via the [`stringfish`](https://github.com/traversc/stringfish) package). The benchmark below shows the time it takes to `qread` random  80 character length strings with and without `ALTREP`. 
