...
|---------------------------------------------------------------------------------------------------|-------------|------------|-----------|------------|--------------|------------|---------------|------------|
| Integer Vector `sample(1e8)`                                                                      | 1015.2  | 889.8 | 27.1 | 135.5 | 686.6   | 442.4 | 699.1    | 567.9 |
| Numeric Vector `runif(1e8)`                                                                       | 861.2  | 954.0 | 24.3 | 131.9 | 744.0   | 638.7 | 754.4    | 848.0 |
| Character Vector `qs::randomStrings(1e7)`                                                         | 1312.9 | 715.8*  | 49.1 | 43.9  | 1440.9  | 59.5  | 1536.3   | 59.3  |
| List `map(1:1e5,sample(100))`                                                          | 197.2  | 311.5 | 7.7  | 123.5 | N/A          | N/A        | N/A           | N/A        |
| Environment `map(1:1e5,sample(100)); names(x)<-1:1e5; as.environment(x)` | 56.0   | 117.5 | 7.7  | 89.6  | N/A          | N/A        | N/A           | N/A        |
"
