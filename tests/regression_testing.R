...
print("qs141 zstd save"); test_compatability(qs141_zstd_save, list(qs141::qread, qs151::qread, qs161::qread, qs173::qread, qs::qread))
print("qs151 lz4 save"); test_compatability(qs151_lz4_save, list(qs141::qread, qs151::qread, qs161::qread, qs173::qread, qs::qread))
print("qs151 zstd save"); test_compatability(qs151_zstd_save, list(qs141::qread, qs151::qread, qs161::qread, qs173::qread, qs::qread))
print("qs161 lz4 save"); test_compatability(qs161_lz4_save, list(qs141::qread, qs151::qread, qs161::qread, qs173::qread, qs::qread))
print("qs161 zstd save"); test_compatability(qs161_zstd_save, list(qs141::qread, qs151::qread, qs161::qread, qs173::qread, qs::qread))
print("qs161 zstd stream save"); test_compatability(qs161_zstd_stream_save, list(qs161::qread, qs173::qread, qs::qread))
print("qs173 lz4 save"); test_compatability(qs173_lz4_save, list(qs141::qread, qs151::qread, qs161::qread, qs173::qread, qs::qread))
print("qs173 zstd save"); test_compatability(qs173_zstd_save, list(qs141::qread, qs151::qread, qs161::qread, qs173::qread, qs::qread))
print("qs173 zstd stream save"); test_compatability(qs173_zstd_stream_save, list(qs::qread)) # 0.16.1_zstd_stream_read cannot read 0.17.1_stream_read due to additional checksum at end of file
print("qs173 zstd stream save no hash"); test_compatability(qs173_zstd_stream_save_nohash, list(qs161::qread, qs173::qread, qs::qread))
print("qs173 no shuffle save"); test_compatability(qs173_no_shuffle, list(qs12::qread, qs131::qread, qs141::qread, qs151::qread, qs161::qread, qs173::qread, qs::qread))
